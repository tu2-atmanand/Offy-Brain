...
>NOTE : the Projects which i have already tried is archived at bottom, the above ones are the reamaining i have to try out.
...
## More Projects : 
https://github.com/search?l=Python&o=desc&q=chatbot&s=&type=Repositories
...
This is very basic and also not for talking at all.